...
# ============================================================================================================================================================= #
# Hash Checker script for md5/sha1/sha256 hashes, version 4.0.8 by Cooleech
...
if [ -r "$SelectedFile" ]; then
	TypeOfHash=`zenity --width=400 --height=290 --list --checklist --title="Hash Checker $AppVer" --text="Select check type for <b>$FileNoPath</b> file" \
...
if [ $? = 0 ]; then
	...
	*SHA256*)
	...
	which xdg-user-dirs-update
	if [ $? = 0 ]; then
		xdg-open "http://www.google.com/search?q=${SearchString// /'+'}" # Search fix
	else
...
# =========================================================== Created using Setup v3.7 by Cooleech ============================================================ #
